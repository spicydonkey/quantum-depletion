...
%%% USER INPUTS
path_config='C:\Users\HE BEC\Documents\MATLAB\quantum-depletion\config_switch_test.m';
...
% n_iter_slice=length(configs.axial_rot_angle);   % number of analysis to iterate
% configs.axial_rot_angle=configs.axial_rot_angle{1}; % TODO - implement - do old for now
% 
...
% end
hist_k_cyl_1D.N=histcounts(k_1D_cyl,hist_k_cyl_1D.binEdge);     % collated
