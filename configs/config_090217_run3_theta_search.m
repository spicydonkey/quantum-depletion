...
%%% Raw data handling
% files -  data file
configs.files.path='C:\Users\HE BEC\Documents\lab\quantum-depletion\exp3\d';    % path to unindexed data file (e.g. 'a\b\datadir\$DATA_FNAME_TOKEN$')
configs.files.id=1:3600;          % file id numbers to use for analysis
...
configs.section_theta_lims=[-pi/4,pi/4];    % in-radial plane angle lims for angular averaging
configs.section_trans_hwidth=5e-3;          % transverse averaging half width [m]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
