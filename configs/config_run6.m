...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fitting region
configs.fit.thermal.k_lim=[3e6 7e6];      % bound k to use for fit [m^-1]
...
configs.fit.thermal.coefname={'Nth','Ta'};         % function coefficient names
configs.fit.thermal.param0=[60e3,400e-9];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fitting region
configs.fit.qd.k_lim=[7e6 10e6];      % k-region of data to fit
