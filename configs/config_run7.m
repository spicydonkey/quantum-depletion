...
configs.cylsect_dtheta=deg2rad(20);
configs.cylsect_theta0=deg2rad(180);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fitting region
configs.fit.thermal.k_lim=[2.3e6 3.3e6];      % bound k to use for fit [m^-1]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% fitting region
configs.fit.qd.k_lim=[3.3e6 7e6];      % k-region of data to fit
